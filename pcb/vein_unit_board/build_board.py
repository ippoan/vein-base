"""Vein Unit board (u1): the board inside the Takachi SIC5-9-2B of the vein unit (station/build_vein_unit.py sic).
...
XG = BX - 4.45 - 0.7                 # J2's origin: its front 0.7 inside the edge (the MP pads keep 0.5 off it)
