...
ケース(`vein_base_v<版>_cup`)は床・ネジのボス・基板を支えるレールに壁を立ち上げ、VoiceS3R の下端 3 mm にかぶせる形です(すき間 0.25 mm、外形 27.3 × 34.6 mm、壁は全方向 1.4 mm 以上)。基板に合わせて USB-C と反対側(+y)へ伸びています。PORT.A のある面はかぶせる部分を切り欠き、反対の面に J3 のケーブル用の上へ開いた溝があります。
...
VoiceS3R(Ext.Pin メス)
  ...
  └ カップ 27.3×34.6(VoiceS3R の下端にかぶせる。M2×12 ネジ 1 本で全体を VoiceS3R に共締め)
```
