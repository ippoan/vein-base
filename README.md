...
ケースは 2 通り出力します。**上ケース + 底板**(2 部品)と、**カップ**(上蓋なしの 1 部品、`vein_base_v<版>_cup`)です。カップは底板と同じ床・ボス・レールに壁を立ち上げ、VoiceS3R の下端 3 mm にかぶせます(すき間 0.25 mm、外形 27.3 mm 角)。PORT.A のある面だけかぶせる部分を切り欠いています。1 部品なので発注が安く、体積も 2.76 cm³(2 部品は合計 3.11 cm³)です。
